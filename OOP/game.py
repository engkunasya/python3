...
#         self.elements = ["thunder", "fire", "water", "ghost", "ice"]
#         self.pokemons = {
#             "jigglypuff":[Jigglypuff(f"P{i}", random.randint(50, 100), self.elements[random.int(0, len(self.elements)-1)], random.randint(50, 100)) for i in range(0, random.randint(3, 15))],
#             "pikachu":[Pikachu(f"P{i}", random.randint(50, 100), self.elements[random.int(0, len(self.elements)-1)], random.randint(50, 100)) for i in range(0, random.randint(5, 20))]
#         }
#     def __str__(self):
#         for pokemonname, pokemonlist in self.pokemons.items():
#             for pokemon in pokemonlist:
